...
<div class="flex items-center justify-evenly gap-4 py-4 bg-white" class:isTopNav={isTopNav}>
    <a href="/frontend/static">
        <svg aria-label="Home" class="_ab6-" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24"
             width="24">
    ...
    <!-- only render search button if it is in the bottom navbar -->
    <!--{#if !isTopNav}-->
    <!--    <a href="/search">-->
    <!--        <svg aria-label="Explore" class="_ab6-" color="#262626" fill="#262626" height="24" role="img"-->
